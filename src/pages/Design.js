...
export function Design() {
  return (
    <div className="flex flex-wrap justify-between">
      <Card />
      <div className="flex flex-col items-center gap-2 text-white w-[450px] h-full p-5 m-5  from-blue-300 via-blue-900 to-purple-400 rounded-md bg-gradient-to-tr dark:from-purple-300  dark:via-purple-700 dark:to-blue-400">
      ...
      <div className="absolute bottom-40 right-60 h-[430px] w-[600px] h-1/1 w-1/1 mx-auto">
        <BodyModelCanvas />
      </div>
    </div>
  );
