...
export function Footer() {
  return (
    <footer className="p-2 w-full min-h-[10vh] text-white dark:text-gray-200 bg-blue-900 dark:bg-purple-800 grid grid-cols-5 items-center text-center">
      <div className="m-1">
        <h5 className="mb-1">Chiara Arrivas</h5>
        <div className="flex flex-row justify-center gap-1 sm:gap-6 flex-wrap">
