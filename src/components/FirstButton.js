export function FirstButton() {
    return (
        <div>
            <button type="submit" className="drop-shadow-xl text-white bg-gradient-to-r rounded-md px-5 py-2 m-5  hover:from-blue-300
            ...
            dark:to-blue-400 dark:from-violet-500  "><span>First Button</span></button>
        </div>
    )
}
