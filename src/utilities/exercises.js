const exercises = {
  ...
  Deltoids: [
    ...
    },
    {
      ...
      equipment: "cable",
      instructions:
        "Inhale, brace your abs, and raise the arms vertically while keeping the elbows slightly bent. Once the arms are parallel with the floor, slowly lower the handle back to the starting position. Repeat for the desired number of repetitions.",
      difficulty: "intermediate",
    ...
    },
    {
      ...
      equipment: "barbell",
      instructions:
        "Perform barbell overhead presses by standing in front of a weighted barbell. Unrack the barbell and hold it on your upper chest and front shoulders. Lift the bar overhead and slowly lower it again. Repeat this movement for the desired amount of repetitions.",
      difficulty: "intermediate",
