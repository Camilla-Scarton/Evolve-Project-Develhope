...
export function Card() {
    return (
        <div>
            <div class="bg-gradient-to-tr drop-shadow-lg from-blue-300 to-blue-900 sm:max-w-sm max-w-[240px] rounded-md overflow-hidden 
            shadow-lg m-5 dark:from-purple-300 dark:to-blue-400 transition-all duration-200 hover:shadow-xl dark:shadow-slate-600 dark:hover:shadow-slate-600">
                    <div class="px-6 py-4">
                        ...
                        <h3 class=" text-white dark:text-black  mb-2">Muscolo</h3>
